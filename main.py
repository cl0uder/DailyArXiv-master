...
keywords = ["Causal Machine Learning", "Distributed Prediction", "Risk Prediction"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/cl0uder/DailyArXiv-master) page for a better reading experience and more papers.**\n\n")
